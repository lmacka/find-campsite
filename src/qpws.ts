...
const API_ENDPOINT = "https://qpws.usedirect.com/QPWS/Facilities/";
const API_DATE_FORMAT = "d-M-yyyy";
...
export async function getCampground(campgroundId: string): Promise<Campground | null> {
  const request = { FacilityId: Number.parseInt(campgroundId), StartDate: "1-3-2021", EndDate: "2-3-2021" };
  try {
...
class Campsite implements ICampsite {
  ...
  getUrl() {
    return `https://qpws.usedirect.com/QPWS/Facilities/SearchView.aspx`;
  }
}
